...
<div class="banner">
       ...
       <div class="barra">
        ...
        <div class="item">
            <h2> DONA  </h2>
            <div id="desc">
            <p> TU TAMBIEN PUEDES AGREGAR TU GRANITO DE ARENA A ESTA CAUSA</p>
            </div>
        </div>

        <div class="item2">
            <h3> + DE 1700 JOVENES BENEFICIADOS DIRECTAMENTE E INDIRECTAMENTE </h3>  
          </div>

        <div class="item">
            
            <H2>SE UN VOLUNTARIO </H2>
            <div id="desc">
                <p>FORMA PARTE DE NUESTRA FAMILIA Y CREZCAMOS JUNTOS</p>
            </div>
        </div>
